...
export const media: Graphic[] = [
  ...
  {
    thumbnail: Image.shibuyaSkyHelipad,
    src: Image.shibuyaSkyHelipad,
    name: "Shibuya Sky Helipad",
    description: "",
    tags: [Tag.shibuyaSky, Tag.image],
  },
  {
    thumbnail: Image.shibuyaSkyQueueWithBro,
    src: Image.shibuyaSkyQueueWithBro,
    name: "Queueing for Shibuya Sky Edge",
    description: "",
    tags: [Tag.shibuyaSky, Tag.brothers, Tag.image],
  },
  {
    thumbnail: Image.shibuyaSkyQueuePortrait,
    src: Image.shibuyaSkyQueuePortrait,
    name: "Shibuya Edge Solo Portrait",
    description: "",
    tags: [Tag.shibuyaSky, Tag.image],
  },
  {
    thumbnail: Image.shibuyaSkyQueueBernard,
    src: Image.shibuyaSkyQueueBernard,
    name: "Looking into the horizon",
    description: "",
    tags: [Tag.shibuyaSky, Tag.image],
  },
  {
    thumbnail: Image.shibuyaSkyQueueMarcus,
    src: Image.shibuyaSkyQueueMarcus,
    name: "Looking away from the horizon",
    description: "",
    tags: [Tag.shibuyaSky, Tag.image],
  },
  {
    thumbnail: Image.shibuyaSkyEdgeRestWithBro,
  ...
  {
    thumbnail: Image.shibuyaSkyEdgeFistWithBro,
    src: Image.shibuyaSkyEdgeFistWithBro,
    name: "Bro Fist at Shibuya Edge",
    description: "",
    tags: [Tag.shibuyaSky, Tag.brothers, Tag.image],
  },
  {
  ...
  {
    thumbnail: Image.shibuyaSkyIndoorBernard,
    src: Image.shibuyaSkyIndoorBernard,
    name: "Shibuya Sky Indoor Night View",
    description: "",
    tags: [Tag.shibuyaSky, Tag.image],
  },
  {
    thumbnail: Image.shibuyaSkyIndoorMarcus,
    src: Image.shibuyaSkyIndoorMarcus,
    name: "Shibuya Sky Indoor Night Portrait",
    description: "",
    tags: [Tag.shibuyaSky, Tag.image],
  },
  {
    thumbnail: Image.hoboShinjukuNorengai,
    src: Image.hoboShinjukuNorengai,
    name: "Hobo Shinjuku Norengai",
    description: "",
    tags: [Tag.hoboShinjukuNorengai, Tag.image],
  },
  {
    thumbnail: Image.hoboShinjukuNorengaiWithBro,
    src: Image.hoboShinjukuNorengaiWithBro,
    name: "Hobo Shinjuku Norengai Wefie",
    description: "",
    tags: [Tag.hoboShinjukuNorengai, Tag.brothers, Tag.image],
  },
  {
    thumbnail: Image.hoboShinjukuNorengaiMenu,
  ...
  {
    thumbnail: Image.hoboShinjukuNorengaiFood,
    src: Image.hoboShinjukuNorengaiFood,
    name: "Food bought from Newstar",
    description: "",
    tags: [Tag.hoboShinjukuNorengai, Tag.food, Tag.image],
  },
  {
